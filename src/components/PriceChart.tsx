...
export const PriceChart = ({ symbol, data }: PriceChartProps) => {
  ...
  return (
    <Card className="p-6 bg-card/50 backdrop-blur-xl border-border/50 shadow-card overflow-hidden">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-1 text-sm font-semibold">
          <TrendingUp className={`w-4 h-4 ${isPositive ? 'text-bullish' : 'text-bearish rotate-180'}`} />
